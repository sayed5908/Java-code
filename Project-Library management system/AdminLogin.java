...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 40, 170, 29));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Username");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, 79, 22));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("Password");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 160, 68, 22));

        adminuser.setBackground(new java.awt.Color(255, 255, 204));
        getContentPane().add(adminuser, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, 154, -1));

        adminpass.setBackground(new java.awt.Color(255, 255, 204));
        getContentPane().add(adminpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 160, 154, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(adminuser.getText().equals("Admin") && adminpass.getText().equals("Admin")){
            ...
            JOptionPane.showMessageDialog(null, "Invali usesrname or passowrd");
        }
